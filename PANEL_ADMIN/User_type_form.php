...
if ($_POST) {
    ...
    $query = mysqli_query($connection, "insert into users_type_tbl(type_name) values('{$uid}')") or die(mysqli_errno($connection));
    if ($query) {
...
?>
            ...
            <div id="page-wrapper">
                <div class="main-page">
                    <div class="forms">
                        <h2 class="title1">User Type Form</h2>
<?php
echo $msg;
?>
                                ...
                                <div class="form-body" style="margin-bottom:300px;">
                                    <form class="form-horizontal" method="post" enctype="multipart/form-data" id="form"> 
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control"  onkeypress="return /[a-z]/i.test(event.key)"  name="uid" placeholder="Enter User Type Name:" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-offset-2">
                                            ...
                                            <button type="button" class="btn btn-primary" onclick="window.location = 'User_type_table.php';">View</button>
                                        </div>
                                    </form> 
                                </div>
                            </div>
