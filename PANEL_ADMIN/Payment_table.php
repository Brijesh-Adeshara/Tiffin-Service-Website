...
<!--                            <h4><a href="payment_form.php">Add Payment</a></h4>-->
                            <h4>Payments</h4>
                            <table class="table" id="table2">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Order Id</th>
                                        <th>Order Amt</th>
                                        <th style="width: 200px; overflow: hidden;">Payment Status</th>
                                        <th>Payment Date</th>
                                        <th>Action</th>
                                    </tr>
                                </thead>
                                ...
                                while ($productrow = mysqli_fetch_array($selectq)) {
                                    ...
                                    echo "<td>{$productrow['order_amount'] }</td>";
                                    echo "<td>{$productrow['payment_status'] }</td>";
                                    echo "<td>{$productrow['payment_date'] }</td>";
