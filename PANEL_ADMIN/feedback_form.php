                                    ...
                                    <form class="form-horizontal" method="post" enctype="multipart/form-data" id="form"> 
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <input type="text" class="form-control"  name="feedback" placeholder="Type Feedback:" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <input type="date" class="form-control"  name="fdate" placeholder="Select Feedback Date:" required>
                                        ...
                                        <div class="col-sm-offset-2">
                                            ...
                                            <button type="button" class="btn btn-primary" onclick="window.location = 'Feedback_table.php';">View</button>
                                        </div>
                                    </form> 
                                </div>
                            </div>
