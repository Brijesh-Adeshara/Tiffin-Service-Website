...
<!--                            <h4><a href="rating_form.php">Add Ratings</a></h4>-->
                            ...
                            <table class="table" id="table2">
                                <thead>
                                  ...
                                  <?php
                                  $selectq = mysqli_query($connection, "select * from ratings_tbl") or die(mysqli_error($connection));
                                $count=mysqli_num_rows($selectq);
                                echo $count    .   " Records Found";
                                while ($productrow = mysqli_fetch_array($selectq)) {
                                    echo "<tr>";
                                    echo "<td>{$productrow['rating_id'] }</td>";
                                    echo "<td>{$productrow['user_id'] }</td>";
                                    echo "<td>{$productrow['user_name'] }</td>";
                                    echo "<td>{$productrow['tiffin_id'] }</td>";
                                    echo "<td>{$productrow['ratings'] }</td>";
                                    echo "<td>{$productrow['rating_date'] }</td>";
