...
<!--                            <h4><a href="complaint_form.php">Add Complaint</a></h4>-->
                            <h4>Complaints</h4>
                            <table class="table" id="table2">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>2</td>
                                        <td>Delivery took way too long than promised</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>3</td>
                                        <td>The Quantity was not what was ordered</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>5</td>
                                        <td>Wrong items were delivered</td>
                                        <td>
                                             <select name="category" class="form-control" required>
                                                 <option value="" disabled selected>
                                                   Choose Complaint Status
                                   ...
                                   <td>10-2-2022</td> 
                                    ...
                                    <tr>
                                        ...
                                        <td>7</td>
                                        <td>Food was not packed properly</td>
                                        <td>
                                             <select name="category" class="form-control" required>
                                                 <option value="" disabled selected>
                                                   Choose Complaint Status
                                ...
                                <td>10-2-2022</td> 
                                    ...
                                    <tr>
                                        ...
                                        <td>8</td>
                                        <td>Food looked totally different from what was displayed</td>
                                        <td>
                                             <select name="category" class="form-control" required>
                                                 <option value="" disabled selected>
                                                   Choose Complaint Status
                       ...
                       <td>10-2-2022</td> 
                                    ...
                                    <tr>
                                        ...
                                        <td>9</td>
                                        <td>Ordered Jain Food and got the Regular one instead</td>
                                        <td>
                                             <select name="category" class="form-control" required>
                                                 <option value="" disabled selected>
                                                   Choose Complaint Status
                                    ...
                                    <tr>
                                        ...
                                        <td>10</td>
                                        <td>Food Quality Not Adequate</td>
                                        <td>
                                             <select name="category" class="form-control" required>
                                                 <option value="" disabled selected>
                                                   Choose Complaint Status
