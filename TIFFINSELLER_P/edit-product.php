...
if($_POST)
{
  ...
  $query  = mysqli_query($connection, "update tbl_product set pro_name ='{$pname}',pro_price ='{$pprice}',pro_details ='{$pdetails}' where pro_id='{$id}'") or die(mysqli_errno($connection));
  if($query)
  {
						...
						<div class="widget-shadow " data-example-id="basic-forms"> 
							...
							<div class="form-body">
                                                            <form class="form-horizontal" method="post" enctype="multipart/form-data"> 
                                                                ...
                                                                <div class="col-sm-9">
                                                                <input type="text" class="form-control" id="inputEmail3" value="<?php echo $selectrow['pro_name'] ?>" name="pname" placeholder="Enter Tiffin Name:" required>
                                                                </div>
                                                                </div>
                                                                <div class="form-group">
                                                                <label for="inputEmail3" class="col-sm-2 control-label">Tiffin Price</label>
                                                                <div class="col-sm-9">
                                                                    <input type="text" class="form-control" id="inputEmail3" value="<?php echo $selectrow['pro_price'] ?>" name="pprice" placeholder="Enter Tiffin Price:" required>
                                                                </div>
                                                                </div>
                                                                <div class="form-group">
                                                                <label for="inputEmail3" class="col-sm-2 control-label">Tiffin Details</label>
                                                                <div class="col-sm-9">
                                                                    <textarea class="form-control" name="pdetails" required> <?php echo $selectrow['pro_details'] ?></textarea>
                                                                </div>
                                                                </div>
                                                                <div class="col-sm-offset-2">
                                                                <button type="submit" class="btn btn-success">Update Tiffin</button>
