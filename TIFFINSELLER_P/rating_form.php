    ...
    <body class="cbp-spmenu-push">
        <div class="main-content">
            ...
            <div id="page-wrapper">
                <div class="main-page">
                    <div class="forms">
                        <h2 class="title1">Rating Form</h2>
                        <?php
                        echo $msg;
                        ?>
                                ...
                                <div class="form-body" style="margin-bottom:200px;">
                                    <form class="form-horizontal" method="post" enctype="multipart/form-data" id="form"> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control"  name="tid" onkeypress="return (event.charCode != 8 && event.charCode == 0 || (event.charCode >= 48 && event.charCode <= 57))" placeholder="Enter Tiffin ID:" >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 control-label">Rating(Out of 5)</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-2 control-label">Rating Date</label>
                                            <div class="col-sm-9">

                                                <input type="date" class="form-control"  name="rdate" placeholder="Select Rating Date:">
                                        ...
                                        <div class="col-sm-offset-2">
                                            ...
                                            <button type="button" class="btn btn-primary" onclick="window.location = 'Rating_table.php';">View</button>
                                        </div>
                                    </form> 
                                </div>
                            </div>
        ...
        <script>
                                               ...
                                               $("#form").validate({
                                                   ...
                                                   messages: {
                                                       ...
                                                       rdate: {
                                                           required: "Please select Rating Date"
                                                       },
                                                       pid: {
